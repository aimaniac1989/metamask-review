 ...
 * @param testParams.dismissStatusPage - Whether to dismiss the smart-tx status page after submitting (default true so Activity navigation works when the footer is shown)
 */
